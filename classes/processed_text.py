...
class ProcessedText:
    ...
    def __init__(self, raw_text: str):
        ...
        raw_text = raw_text.replace("can't", "can not")
        ...
        raw_text = raw_text.replace("hadn't", "had not")
        raw_text = raw_text.replace("hasn't", "has not")
        raw_text = raw_text.replace("haven't", "have not")
        raw_text = raw_text.replace("he'd", "he would")
        raw_text = raw_text.replace("he'll", "he will")
        ...
        raw_text = raw_text.replace("let's", "let us")
        raw_text = raw_text.replace("she'd", "she would")
        raw_text = raw_text.replace("she'll", "she will")
        ...
        raw_text = raw_text.replace("there's", "there is")
        ...
        raw_text = raw_text.replace("weren't", "were not")
        raw_text = raw_text.replace("what're", "what are")
        raw_text = raw_text.replace("what's", "what is")
        raw_text = raw_text.replace("what've", "what have")
        raw_text = raw_text.replace("where's", "where is")
        raw_text = raw_text.replace("who'd", "who would")
        raw_text = raw_text.replace("who'll", "who will")
        raw_text = raw_text.replace("who're", "who are")
        raw_text = raw_text.replace("who's", "who is")
