...
class BasicBResponder(TextGenerator):
  ...
  def rate(self, in_text: ProcessedText) -> float:
    ...
    if tags == ['NN'] or tags == ['NNP']: #user input is a singular noun
      responses.append((0.60 + random(), "Is a" + words[0] + " all you want to chat about?"))
      responses.append((0.55 + random(), "Wow, I was not expecting a " + words[0]))
      responses.append((0.55 + random(), "Man, I've always wanted a " + words[0]))
