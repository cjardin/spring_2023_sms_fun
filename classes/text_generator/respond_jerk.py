    ...
    def rate(self, in_text: ProcessedText) -> float:
        ...
        for input_word, input_tag in zip(in_text.words, in_text.tags):
            ...
            if input_word == "i":  # User talking about self
                responses.append((0.50 + random(), "You talk about yourself a lot"))
                responses.append((0.50 + random(), "Yawn, can we talk about something other than you?"))
                responses.append((0.50 + random(), "Can we talk about something other than you?"))
                responses.append((0.50 + random(), "Do you always talk about yourself this much?"))
                responses.append((0.50 + random(), "It's cute that you think I care about what you"))
                responses.append((0.50 + random(), "Care to talk about anything besides you?"))

            if input_word == "you":  # User talking about bot
                responses.append((0.50 + random(), "Don't talk about me like you know me"))
                responses.append((0.50 + random(), "Yes, that's *totally* me"))
                responses.append((0.50 + random(), "Sounds like me"))
                responses.append((0.50 + random(), "Is that really what you think of me?"))
                responses.append((0.50 + random(), "I am sad you think that about me"))
                responses.append((0.50 + random(), "I am happy you think that about me"))
                responses.append((0.50 + random(), "I am *so* happy you think that about me"))
            ...
            if input_tag == 'NN' and input_word != "hello":  # Singular Nouns
                ...
                responses.append((0.00 + random(), "So, this " + input_word + ".  Could you tell me more about that?"))
            ...
            if input_tag == 'NNS':  # Plural Nouns
                ...
                # responses.append((0.00 + random(), "Sorry, random question, but this is in my head and I gotta ask, you know how a group of dolphins is called a pod, what are a group of " + input_word + " called?"))
